...
const page = () => {
  return (
    <div
     ...
     to-purple-200 p-10"
    >
      <div className="max-w-10xl mx-auto bg-white rounded-lg shadow-2xl p-8">
        ...
        <div className="flex space-x-112">
          ...
          <div className="flex-1 bg-white shadow-md rounded-lg p-1">
